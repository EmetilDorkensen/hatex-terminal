          ...
          <div style={{ display: "flex", flexWrap: "wrap", gap: "48px", marginBottom: "56px" }}>
            ...
            <div style={{ flex: "0 0 260px" }}>
              ...
              <div style={{ display: "flex", gap: "10px" }}>
                ...
                {/* NOUVO: Ikon TIKTOK la */}
                <a href="https://tiktok.com/@hatexcard" target="_blank" rel="noopener noreferrer" style={{ width: "32px", height: "32px", borderRadius: "8px", background: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.07)", display: "flex", alignItems: "center", justifyContent: "center", color: "rgba(255,255,255,0.4)", transition: "all 0.2s" }} className="hover:text-fuchsia-400 hover:border-fuchsia-400/30">
