-- ============================================================================
-- ASIRE RPC review ajan/antrepriz egziste (korije "schema cache" error)
-- Kouri NAN SUPABASE SQL EDITOR kounye a si ou wè erè lè w apwouve/rejte ajan.
-- ============================================================================
...
-- Rafrechi PostgREST schema cache (Supabase API)
