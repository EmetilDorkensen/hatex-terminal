-- ============================================================================
-- NETWAYE DOUBLON RPC — ansyen overload ki pa SECURITY DEFINER
-- ============================================================================
-- Apre 20260734, verifye ou te wè plizyè liy pou menm non fonksyon an
-- (eg. transfer_wallet_to_card true + false). Sa vle di gen ANSYEN
-- vèsyon ak diferan paramèt ki toujou egziste. CREATE OR REPLACE pa
-- efase yo — fòk DROP tout overload yo, epi rekreye sèlman vèsyon sekirize a.
-- ============================================================================

-- 1) Efase TOUT overload yo pou fonksyon sa yo
DO $$
DECLARE r RECORD;
BEGIN
  FOR r IN
...
-- ============================================================
-- 2. Rekreye sèlman vèsyon sekirize yo (menm kòd ak 20260734)
-- ============================================================
...
-- ============================================================================
-- VERIFYE (dwe gen EGZAKTMAN 1 liy pou chak fonksyon, tout prosecdef = true):
--
-- SELECT
--   p.proname,
