...
const nextConfig = {
  ...
  async headers() {
    const csp = [
      ...
      "font-src 'self' data:",
      "connect-src 'self' https://*.supabase.co wss://*.supabase.co https://api.ipify.org https://api.telegram.org https://challenges.cloudflare.com https://cloudflareinsights.com",
